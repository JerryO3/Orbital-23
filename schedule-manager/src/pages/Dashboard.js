  ...
  return (
    <div>
      <div class="bg-slate-200 sm:flex sm:px-5 h-fit">
        ...
        <div class=" bg-slate-200 lg:w-2/5 outline-1 py-10 sm:px-5 h-fit items-center">
          <div class="pb-5">
          ...
          <div class="bg-slate-200 lg:w-3/5 h-full sm:py-10 sm:px-5 items-center lg:hidden pb-4">
          <div class="col-start-1 bg-slate-100 h-full sm:px-10 pb-20 pt-10 items-center rounded-2xl">
        ...
        <div class="bg-slate-200 lg:w-3/5 h-full sm:py-10 sm:px-5 items-center hidden lg:block">
